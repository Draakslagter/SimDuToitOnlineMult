...
public class LobbyUI : MonoBehaviour
{
    ...
    private void Awake() {
        ...
        changeMarineButton.onClick.AddListener(() => {
            LobbyManager.Instance.UpdatePlayerData(PlayerCharacter.Marine);
        });
        changeNinjaButton.onClick.AddListener(() => {
            LobbyManager.Instance.UpdatePlayerData(PlayerCharacter.Ninja);
        });
        changeZombieButton.onClick.AddListener(() => {
            LobbyManager.Instance.UpdatePlayerData(PlayerCharacter.Zombie);
        });
